...
def create(
    ...
    return crud.country.create(db, data)
...
def update(
    ...
    return crud.country.update(db, id, data)
...
def get_by_id(
    ...
    db_record = crud.country.get_by_id(db, id=id)
